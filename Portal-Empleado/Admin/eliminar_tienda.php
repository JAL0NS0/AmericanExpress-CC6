...
<head>
    ...
    <title>Eliminar Tienda-AMERICAN EXPRESS</title>
    <!-- CSS bootstrap -->
                            ...
                            <div class="col-lg-12 mb-3 mt-2">
                                <div class="card rounded-1">
                                    <div class="card-header bg-light">
                                        <h6 class="font-weight-bold mb-0">ELIMINAR TIENDA</h6>
                                    </div>
                                    <div class="card-body">
                                       <div class="container" >
                                        <div class="row">
                                            <div class="col-4">
                                                <?php 
                                                    $id_tienda = $_GET['id'];
                                                    $query = "DELETE FROM public.tienda
                                                    WHERE id= $id_tienda;";
                                                    $result = pg_query($dbconn,$query); 
                                                    if($result){
                                                        echo "<div class='row'>
                                                                    <div> TIENDA ELIMINADA CORRECTAMENTE</div>
                                                                </div>
                                                                <div class='row'>
                                                                    <div><a class='btn btn-primary' href='./tiendas.php'>CONTINUAR</a></div>
                                                                </div>";
                                                    }else{
                                                        echo "<div class='row'>
                                                                <div> OCURRIO UN ERROR TIENDA NO HA SIDO ELIMINADA</div>
                                                            </div>
                                                            <div class='row'>
                                                                <div><a class='btn btn-primary' href='./tiendas.php?res=false'>REGRESAR</a></div>
                                                            </div>";
                                                    }
                                                ?>
                                            </div>
