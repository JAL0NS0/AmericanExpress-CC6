                                       ...
                                       <div class="container" >
                                        <div class="row">
                                            ...
                                            <?php 
                                                ...
                                                if($result){
                                                    echo "<div class='row'>
                                                                <div> EMPLEADO INGRESADO CORRECTAMENTE</div>
                                                            </div>
                                                            <div class='row'>
                                                                <div><a class='btn btn-primary' href='./empleados.php'>REGRESAR</a></div>
                                                            </div>";
                                                }else{
                                                    echo "<div class='row'>
                                                            <div> OCURRIO UN ERROR EMPLEADO NO HA SIDO INGRESADO</div>
                                                        </div>
                                                        <div class='row'>
                                                            <div><a class='btn btn-primary' href='./nuevo_empleado.php?res=false'>REGRESAR</a></div>
                                                        </div>";
                                                }
                                                ?>
                                            </div>
